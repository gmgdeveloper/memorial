...
<body>
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <form action="<?php echo e(route('login_with_access_code')); ?>" method="POST" id="loginForm">
                                        ...
                                        <div class="row" id="guestFields">
                                            ...
                                            <div class="col-lg-2 mt-2">
                                                <h5 class="mt-2 bottommargindh" style="font-family: 'Josefin Sans Bold';font-size: 18px;">HONOUREE EMAIL</h5>
                                            </div>
                                            <div class="col-lg-10 mt-2 mb-2">
                                                <input type="text" class="form-control" name="honouree_email" style="border: 2px solid #BE9438;"  placeholder="Honouree Email">
                                            </div>
                                            <div class="col-lg-2 mt-2">
                                            ...
                                            <div class="col-lg-1 col-sm-1 widthsetingcheck" style="padding-right: 0px!Important;">
                                                <input type="checkbox" class="form-control float-right mr-2 mt-1 margintopchecking" name="privacy" style="border-color:#BE9438;width: 25px;height: 35px;">
                                            </div>
                                            ...
                                            <div class="col-lg-1 col-sm-1 mt-2 widthsetingcheck" style="padding-right: 0px!Important;">
                                                <input type="checkbox" class="form-control float-right mr-2 margintopchecking" name="policy" style="border-color:#BE9438;width: 25px;height: 35px;">
                                            </div>
                                            ...
                                            <div class="col-lg-5 col-sm-5 offset-lg-1 mt-2">
                                                <button type="submit" class="login-butn  btn btn-large mb-4 requestaccess" style="font-weight:bold;border-radius:20px;width:100%;background-color:#BE9438;border-color: #BE9438;font-family: 'Josefin Sans Bold';">LOG IN</button>
                                            </div>
                                            <div class="col-lg-5 col-sm-5 mt-2">
                                                <button class="btn btn-large mb-4 requestaccess request_access_code" style="font-weight:bold;border-radius:20px;width:100%;background-color:#BE9438;border-color: #BE9438;font-family: 'Josefin Sans Bold';" onclick="submitForm()">REQUEST ACCESS</button>
                                            </div>
                                        </div>
                                        <div class="row" id="honoureeFields" style="display:none; ">
                                            ...
                                            <div class="col-lg-1 col-sm-1 widthsetingcheck" style="padding-right: 0px!Important;">
                                                <input type="checkbox" class="form-control float-right mr-2 mt-1 margintopchecking" name="privacy_policy" style="border-color:#BE9438;width: 25px;height: 35px;">
                                            </div>
                                            <div class="col-lg-11 col-sm-11 widthseting" style="padding-left: 0px!Important;">
                                                <p class="mt-1 text-muted widthsetingtext" style="font-family: 'Josefin Sans Light';">Entering this site is confirmation that I accept 'A life Worth Remembring' Terms, Conditions and Privacy Policy</p>
                                            </div>
    ...
    <script>
        function showFields() {
            ...
            if (radioGuest.checked) {
                ...
                form.action = '/login_with_access_code';
            } else {
    ...
    <script>
        function submitForm() {
            var form = document.getElementById('loginForm');
            form.action = '/request_with_access_code';
