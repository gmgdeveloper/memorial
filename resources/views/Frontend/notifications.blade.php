                                    ...
                                    <table class="table" style="border: 2px solid #BE9438!important;">
                                        ...
                                        <tbody>
                                            @if(!empty($notifications))
                                                ...
                                                <tr>
                                                    <td style="font-family: 'Josefin Sans Light';">{{$notification->fullname}}</td>
                                                    <td style="font-family: 'Josefin Sans Light';">{{$notification->email}}</td>
                                                    <td style="font-family: 'Josefin Sans Light';">{{$notification->legacyurl}}</td>
                                                    <td style="font-family: 'Josefin Sans Light';">{{$notification->relationship}}</td>
                                                    <td style="font-family: 'Josefin Sans Light';">
                                                        @if($notification->status == 0)
                                                            <a href="{{route('giveaccess',$notification->id)}}" class="btn btn-sm text-white" style="background-color:#BE9438;">Give Access</a>
                                            ...
                                            @else
                                            <tr>
                                                <td style="font-family: 'Josefin Sans Light';text-align:center;" colspan="12">{{ 'Data Not Found' }}</td>
                                            </tr>
                                            @endif
                                        </tbody>
                                    </table>
