        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <button class="btn btn-primary" onclick="window.location.href='{{ route('admin.add_category') }}'">
                                            ...
                                            <td class="category-id">{{ $category->id }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-info btn-sm mr-1"
                                                            onclick="window.location.href='{{ route('admin.editCategory', $category->id) }}'">
        ...
        $('.delete-btn').click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ route("admin.delete_category", ":id") }}'.replace(':id', id),
                        data: {
                            _token: '{{ csrf_token() }}'
